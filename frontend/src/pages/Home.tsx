        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A complete platform to create, deploy and manage your AI agents 
              in a secure and high-performance blockchain environment.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Join the SwarmNode community and start deploying your 
              intelligent agents on Avalanche today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/dashboard"
